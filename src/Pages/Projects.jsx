        ...
        >
            ...
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden transform transition-transform hover:scale-105 duration-300">
              <div className="relative">
                <img
                  src="../..//Refokuss/2.png"
                  alt="Project 1"
                  className="w-full h-48 sm:h-64 md:h-96 object-cover hover:opacity-90 transition-opacity"
                />
              ...
              <div className="p-6 md:p-8 bg-gradient-to-b from-white to-gray-50">
                ...
                <div className="mt-6 flex gap-4">
                  <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-full text-sm font-medium">React.js</span>
                  <span className="px-4 py-2 bg-purple-100 text-purple-600 rounded-full text-sm font-medium">Animation</span>
                </div>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden transform transition-transform hover:scale-105 duration-300">
              ...
              <div className="p-6 md:p-8 bg-gradient-to-b from-white to-gray-50">
                <h3 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800 hover:text-blue-600 transition-colors">Movie APP</h3>
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                ...
                <div className="mt-6 flex gap-4">
                  <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-full text-sm font-medium">React.js</span>
                  <span className="px-4 py-2 bg-green-100 text-green-600 rounded-full text-sm font-medium">TMDB API</span>
                </div>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden transform transition-transform hover:scale-105 duration-300">
              ...
              <div className="p-6 md:p-8 bg-gradient-to-b from-white to-gray-50">
                <h3 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800 hover:text-blue-600 transition-colors">E-Commerce Store</h3>
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                ...
                <div className="mt-6 flex gap-4">
                  <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-full text-sm font-medium">React.js</span>
                  <span className="px-4 py-2 bg-yellow-100 text-yellow-600 rounded-full text-sm font-medium">Node.js</span>
                  <span className="px-4 py-2 bg-red-100 text-red-600 rounded-full text-sm font-medium">Express</span>
                </div>
              </div>
            </div>
          </SwiperSlide>
