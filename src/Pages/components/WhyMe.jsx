...
// Lucide icons
import { Bluetooth, Users, Zap, Target, Lightbulb } from "lucide-react";
...
const data = [
  ...
  },
  {
    ...
    description:
      "Focused on clean, optimized code and performance without compromising experience.",
  },
  {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-black to-zinc-900 py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-8 sm:space-y-12 lg:space-y-16">
        ...
        >
          <AnimatedGradientText>Why Choose Me Over Others</AnimatedGradientText>
        </motion.h2>

        {/* Introduction */}
        <MagicCard className="text-base px-4 sm:px-6 lg:px-8">
          <p className="text-gray-300 p-8 text-base sm:text-lg leading-relaxed">
        ...
        {/* Final CTA Section */}
        <MagicCard className="text-base px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col px-10 py-6 sm:flex-row items-start gap-4 sm:gap-6">
            ...
            <div>
              ...
              <p className="text-gray-300 text-base sm:text-lg mb-4 sm:mb-6">
                Let's transform your ideas into something extraordinary. I bring
                strategy, performance, and creativity together to create real
