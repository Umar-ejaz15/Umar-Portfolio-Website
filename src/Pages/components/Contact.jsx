...
const Contact = () => {
  return (
    <section id='contact' className="relative min-h-screen bg-gradient-to-b from-zinc-900 to-black py-24 px-4 sm:px-6 lg:px-8">
      {/* Particles */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row gap-16">
        ...
        >
          <BoxReveal>
            <h2 className="text-4xl font-bold text-white mb-12 border-b-2 border-zinc-500 pb-4 inline-block">Connect With Me</h2>
          </BoxReveal>
        ...
        >
          <BoxReveal>
            <h2 className="text-4xl font-bold text-white mb-12 border-b-2 border-zinc-500 pb-4 inline-block">Get In Touch</h2>
          </BoxReveal>
