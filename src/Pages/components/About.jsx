...
import { CloudLightning, Diamond, Laptop, Rocket, Stars } from "lucide-react";
...
const About = () => {
  ...
  <div>
    ...
    >
      ...
      and turn it into something functional, beautiful, and
      profitable? You're in the right place.
    </motion.p>
    {/* Move ShineBorder here */}
    <ShineBorder />
  </div>
</MagicCard>
                ...
                <div className="flex flex-col md:flex-row items-start gap-4 sm:gap-6">
                  ...
                  <div className="p-2">
                    ...
                    <p className="text-base sm:text-lg mb-4 sm:mb-6 text-gray-300 leading-relaxed">
                      ...
                      complete MERN stack and a passion for clean, efficient
                      code, I'm here to turn your vision into reality. Let's
                      build something that's not just functional, but absolutely
                      extraordinary.
                    </p>
                    <motion.p
                    ...
                    >
                      Let's Transform Your Ideas Into Reality - Your Success
                      Story Starts Here! 🚀
                    </motion.p>
                  </div>{" "}
                </div>
