...
const Side = () => {
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      <div className="p-3 font-bold bg-zinc-900 w-full h-auto items-center flex gap-3 justify-center hover:border-[2px] hover:border-white text-center text-xl sm:text-2xl border-[2px] border-transparent rounded-lg transition-all duration-300 cursor-pointer hover:bg-zinc-800">
      ...
      <div className="p-4 sm:p-3 bg-zinc-900 w-full h-full flex flex-col gap-5 sm:gap-7 hover:border-[2px] hover:border-white text-center items-center text-xl sm:text-2xl border-[2px] border-transparent rounded-lg transition-all duration-300 hover:bg-zinc-800">
        ...
        <div className="w-full space-y-5">
          <div>
            <h1 className="text-left text-lg sm:text-xl text-white/90 mb-3 flex items-center gap-2">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="http://github.com/umar-ejaz15/" target="_blank" className="flex items-center gap-2 bg-zinc-800 px-4 py-2 rounded-lg hover:bg-zinc-700 transition-all duration-300 hover:scale-105">
              <FaGithub className="text-white hover:text-gray-300" />
              <span className="text-sm">View GitHub</span>
            </a>
            <a href="https://www.linkedin.com/in/umar-ejaz-6734402b1/" target="_blank" className="flex items-center gap-2 bg-zinc-800 px-4 py-2 rounded-lg hover:bg-zinc-700 transition-all duration-300 hover:scale-105">
              <FaLinkedin className="text-blue-400 hover:text-blue-300" />
              <span className="text-sm">Connect on LinkedIn</span>
            </a>
            <a onClick={()=>opencv()} className="flex items-center gap-2 bg-zinc-800 px-4 py-2 rounded-lg hover:bg-zinc-700 transition-all duration-300 hover:scale-105">
