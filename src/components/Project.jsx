...
const Project = ({ data, count, mover }) => {
  ...
  return (
    <div
      ...
      className={`w-full min-h-[15rem] mx-auto border-b border-t border-zinc-600 flex flex-col lg:flex-row px-4 sm:px-6 lg:px-10 py-6 lg:py-10 items-center hover:bg-zinc-800`}
    >
