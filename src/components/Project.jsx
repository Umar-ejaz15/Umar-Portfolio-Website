...
const Project = ({ data, count, mover }) => {
  ...
  return (
    <div
      ...
      className={`w-full min-h-[15rem] mx-auto border-b border-t border-zinc-600 flex flex-col lg:flex-row px-4 sm:px-6 lg:px-10 py-6 lg:py-10 items-center hover:bg-zinc-800 cursor-pointer`}
    >
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-end text-center lg:text-right">
        <div className="w-full sm:w-4/5 lg:w-2/3 flex flex-col items-center lg:items-end">
          ...
          <p className="text-sm text-center w-full text-blue-400">Click me to view project</p>
        </div>
      </div>
    </div>
  );
