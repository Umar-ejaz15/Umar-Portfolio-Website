    ...
    <div className="h-full px-4 py-6 bg-zinc-900 flex flex-col hover:border-[2px] hover:border-white border-[2px] border-transparent rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-zinc-800">
      ...
      <div className="space-y-8 flex-1">
        <div className="bg-zinc-800/50 p-4 rounded-lg">
          <p className="text-base md:text-sm text-gray-300 hover:text-white transition-colors leading-relaxed">
        ...
        <div className="bg-zinc-800/50 p-4 rounded-lg">
          ...
          <ul className="grid grid-rows-2 md:rows-rows-3 lg:grid-rows-4 gap-4">
        ...
        <div className="bg-zinc-800/50 p-4 rounded-lg mt-auto">
          <h3 className="text-xl md:text-2xl font-semibold mb-4 text-white flex items-center gap-3">
            <FaGamepad className="text-purple-400 animate-bounce" />
            Interests & Hobbies
          </h3>
          <div className="flex items-start gap-4 flex-wrap">
            <FaBook className="text-green-400 text-2xl mt-1" />
            <p className="text-base md:text-sm text-gray-300 leading-relaxed hover:text-white transition-colors flex-1">
