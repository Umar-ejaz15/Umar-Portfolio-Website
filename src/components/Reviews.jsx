  ...
  const reviews = [
    {
      name: 'Alice Johnson',
      rating: 5,
      review: "This service has been amazing. I couldn't be more satisfied with the results!",
      location: 'New York, USA'
    },
    {
      name: 'John Doe',
      rating: 4,
      review: "A great experience overall! The team was very helpful, and the product is top-notch.",
      location: 'London, UK'
    },
    {
      name: 'Sarah Lee',
      rating: 5,
      review: "Exceptional quality and customer service. I highly recommend this company!",
      location: 'Sydney, Australia'
    },
    {
      name: 'Michael Smith',
      rating: 3,
      review: "Good service, but there is room for improvement in the user interface.",
